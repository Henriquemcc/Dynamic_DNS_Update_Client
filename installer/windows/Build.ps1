...
Copy-Item -Path ([System.IO.Path]::Combine([System.IO.Path]::GetDirectoryName([System.IO.Path]::GetDirectoryName([System.IO.Path]::GetDirectoryName($MyInvocation.MyCommand.Definition))), "app", "build", "libs", "app.jar")) -Destination ([System.IO.Path]::Combine($installerStage, "app.jar"))
